...
#for each function in IDA, get the AST, print json representation

try:
    headlessIda = HeadlessIda("/home/logan/idaedu-8.4/ida64", "/home/logan/Dev/IntermediateDragon/activeExperiments/ghidraEnvVarTest/rundata/run1/0.libemotion.so.1.26/0.libemotion.so.1.26")
